...
actual_data_subset_charles <- actual_data_charles[actual_data_charles$time >= as.Date("2020-01-01") & actual_data_charles$time <= as.Date("2023-05-01"), ]
...
actual_data_subset_madrid <- actual_data_madrid[actual_data_madrid$time >= as.Date("2020-01-01") & actual_data_madrid$time <= as.Date("2023-05-01"), ]
...
actual_data_subset_roma <- actual_data_roma[actual_data_roma$time >= as.Date("2020-01-01") & actual_data_roma$time <= as.Date("2023-05-01"), ]
...
actual_data_subset_kob <- actual_data_kob[actual_data_kob$time >= as.Date("2020-01-01") & actual_data_kob$time <= as.Date("2023-05-01"), ]
...
actual_data_subset_oslo <- actual_data_oslo[actual_data_oslo$time >= as.Date("2020-01-01") & actual_data_oslo$time <= as.Date("2023-05-01"), ]
